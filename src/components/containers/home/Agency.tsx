          ...
          <div className="col-12 col-lg-6">
            <div className="agency__content section__content">
              ...
              <h2 className="title title-anim">
                Мы кретивная веб студия в Астане
              </h2>
              <div className="paragraph">
                <p>
                  Мы представляем собой инновационную компанию полного цикла, фокусирующую свою деятельность на высококачественном дизайне, разработке передовых веб-проектов и стратегиях цифрового маркетинга. Наш спектр услуг охватывает не только создание привлекательных и функциональных веб-сайтов, но также включает в себя экспертные решения в области оптимизации для поисковых систем (SEO), эффективного контент-маркетинга и комплексного развития брендов.
                </p>
              </div>
              <div className="skill-wrap">
                <div className="skill-bar-single d-none">
                  <div className="skill-bar-title">
                    <p className="primary-text">Веб дизайн</p>
                  </div>
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Веб разработка</p>
                  </div>
